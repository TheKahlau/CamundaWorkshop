...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "TwitterQa";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "TwitterQa.war")
            ...
            .addPackages(false, "CamundaWorkshop") // not recursive to skip package 'nonarquillian'
